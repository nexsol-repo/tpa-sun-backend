...
public class InsuranceApplicationEntity extends BaseEntity {
	...
	public static InsuranceApplicationEntity fromDomain(InsuranceApplication domain) {
		...
		if (domain.applicantInfo() != null)
			entity.applicantInfo = new ApplicantInfoEmbeddable(domain.applicantInfo());
	...
	public void update(InsuranceApplication domain) {
		...
		if (domain.condition() != null)
			this.conditionInfo = new ConditionEmbeddable(domain.condition());
		if (domain.coverage() != null)
