...
public record InsuranceConditionRequest(
        Boolean essInstalled,
        Long propertyDamageAmount,
        Boolean civilWorkIncluded,
        Long liabilityAmount,
        Long businessInterruptionAmount,
        LocalDate startDate,

        // 사고 이력
        Boolean accidentHistory,
        LocalDate accidentDate,
        Long accidentPayment,
        String accidentContent,

        // 질권 설정
        Boolean pledgeSet,
        String pledgeBankName,
        String pledgeManagerName,
        String pledgeManagerPhone,
        Long pledgeAmount,
