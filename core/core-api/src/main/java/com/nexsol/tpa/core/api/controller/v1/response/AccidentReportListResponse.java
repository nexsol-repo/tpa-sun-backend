...
@Builder
public record AccidentReportListResponse(Long reportId, String accidentNumber, String plantName, String accidentType,
		LocalDateTime accidentDate, LocalDateTime reportedAt, AccidentStatus status) {
